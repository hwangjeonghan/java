...
public class Application01 {
    public static void main(String[] args) {
        ...
        *  2-1. 자동형변환이 적용되지 않는 경우 강제 형변환이 필요하디.
        * */
        ...
        //int result1 = nim1 + num2; //자동으로 큰 쪽 자료형인 long으로 변경 후계산하기 떄문에 int형 변수에 값을 담을 수 없다.
        ...
        /* 필기.
         * 정수를 실수로 변경할 떄 소수점 자리수가 없어도 실수형태로 표햔이 가능하다. 이 때 데이터 손실이 없기 때문에 자동형변환이 가능하다.
         **/

        /*설명.
        * 실제 값을 저장하는 매커니즘을 가진 것과 달리 실수형은 지수부와 가수부를 따로 나눠서 작성하기 떄문에 바이트 크기보다 훨씬 더 많은 값을 표현할 수 있다.
         */

        //long eight = 888888888888888888; // 이것도 자동으로 형변환 된 것이다.(int 범위 벗어나면 에러 발생)
        long eight = 8;
        float four = eight;
