...
public class Application01 {
    public static void main(String[] args) {
        ...
        **/
        int num = 10;
        int num2 = -10;
        // num1 일과 num2를 삼항 연산자를 이용하여 양수 또는 음수로 표현해 주세요.

        System.out.println(("num1은 : " + ((num >= 0)? "양수이다" : "0또는 음수이다.")));
        System.out.println(("num2는 : " + ((num <= 0)? "양수이다" : "0 또는 음수이다")));
        ...
        // num5가 양수인지 음수인지 0인지 확인해주세요
         ...
         int num6 = 10; // 숫자바꿀때마다
         String result6 = (num6 == 0)? "0입니다" : (num6 == 1)? "1입니다" : (num6 == 2)? "2입니다" : (num6 == 3)? "3입니다" : (num6 > 3)? "3초과입니다" : "음수이거나 숫자가아닙니다.";
