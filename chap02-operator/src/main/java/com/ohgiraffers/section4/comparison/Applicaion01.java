...
public class Applicaion01 {
    public static void main(String[] args) {
        ...
        *  '!=' : 왼쪽의 피연산자와 오른쪽의 피연산자가 같으면 true 같으면 false를 반환
        *  '>=' : 왼쪽의 피연산자와 오른쪽의 피연산자 보다 크거나 같으면 true 아니면 false를 반환
        ...
        **/
        ...
        System.out.println("inum1이 inum2가 큰지 비교 : " + (inum1 > inum2));
        System.out.println("inum1이 inum2가 작은지 비교 : " + (inum1 < inum2));
        System.out.println("inum1이 inum2가 같거나 큰지 비교 : " + (inum1 >= inum2));
        System.out.println("inum1이 inum2가 같거나 작은지 비교 : " + (inum1 <= inum2));
